const RocksDB = require('@geekberry/rocksdb');
...
beforeAll(async () => {
  const database = new RocksDB({ location: './DB_ROCKS' });

  server = new Server({ host: '127.0.0.1', port: 6082, database });
  client = new Client({ host: '127.0.0.1', port: 6082, asBuffer: false });
